  ...
  return (
    <>
      <article className="group/article p-4 text-left flex flex-col w-[100%] text-grey-900 rounded-xl mt-3 mb-3 bg-white text-secondary text-lg drop-shadow-xl sm:ml-0">
        <div className="flex flex-row align-top justify-start p-2 rounded-lg text-left transition ease-in-out delay-150 betterhover:group-hover/article:-translate-y-0.5 betterhover:group-hover/article:scale-[103%] duration-300 ...">
          <button
            type="button"
        ...
        <div className="flex flex-row justify-end">
          ...
          >
            <svg
              className="w-6 h-6 text-secondary transition ease-in-out delay-150 betterhover:group-hover/article:text-secondaryB-500"
              aria-hidden="true"
          ...
          >
            <button
              type="button"
              className="group border border-secondaryB-500 text-secondaryB-500 betterhover:hover:text-white  betterhover:hover:bg-secondaryB-500 font-medium rounded-lg text-sm p-2.5 text-center"
            >
              <svg
                className="w-4 h-4 text-secondaryB-500 betterhover:group-hover:text-primaryB"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 23 23"
