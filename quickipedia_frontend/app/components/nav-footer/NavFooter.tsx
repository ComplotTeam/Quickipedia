...
export const NavFooter = () => {
  return (
    ...
    <div className="grid h-full max-w-lg grid-cols-3 mx-auto">
        <Link href={"/"} data-tooltip-target="tooltip-home" type="button" className="inline-flex flex-col items-center justify-center px-4 rounded-xl hover:bg-rose-400/30 group">
        ...
        <Link href={"/articles/all"} data-tooltip-target="tooltip-new" type="button" className="inline-flex flex-col items-center justify-center px-4 rounded-xl hover:bg-rose-400/30 group">
        ...
        <Link href={"/search"} data-tooltip-target="tooltip-settings" type="button" className="inline-flex flex-col items-center rounded-xl justify-center px-4 hover:bg-rose-400/30 group">
